...
class DetailLokasiSeeder extends Seeder
{
  public function run()
  {
    $detailLokasi = [
      ...
      ['name' => 'rak_packing', 'label' => 'Area Packanging YPC', 'category' => 'Pakaging Area', 'plan' => 'Plan 1'],
      ['name' => 'rak_packing', 'label' => 'Area Packanging Carton Box WH(2)', 'category' => 'Pakaging Area', 'plan' => 'Plan 1'],
      ['name' => 'rak_packing', 'label' => 'Area Packanging Carton Box WH(3)', 'category' => 'Pakaging Area', 'plan' => 'Plan 1'],
      ...
      ['name' => 'rak_subcont_wip', 'label' => 'Area Subcont FG', 'category' => 'Area Subcont', 'plan' => 'Plan 1'],
      ['name' => 'rak_subcont_wip', 'label' => 'Area Subcont WIP', 'category' => 'Area Subcont', 'plan' => 'Plan 1'],
    ...
    foreach ($detailLokasi as $lokasi) {
      DetailLokasi::updateOrInsert(
        ['name' => $lokasi['name']],
        ['label' => $lokasi['label'], 'category' => $lokasi['category'], 'plan' => $lokasi['plan']]
      );
    }
  }
}
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create Forecast</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <form class="row g-3 needs-validation" novalidate enctype="multipart/form-data" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="part_name" name="part_name" value="{{ old('part_name') }}" required readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="part_number" class="form-label">Part Number</label>
                            <input type="text" class="form-control" id="part_number" name="part_number" value="{{ old('part_number') }}" required readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="forecast_qty" class="form-control" id="forecast_qty" value="{{ old('forecast_qty') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="min_stok" class="form-label">Min Stok</label>
                            <input type="number" name="min_stok" class="form-control" id="min_stok" value="{{ old('min_stok') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="max_stok" class="form-label">Max Stok</label>
                            <input type="number" name="max_stok" class="form-control" id="max_stok" value="{{ old('max_stok') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="forecast_date" class="form-label">Actual Date</label>
                            <input type="date" name="forecast_date" class="form-control" id="forecast_date" value="{{ old('forecast_date') }}" required>
                        </div>
                    </div>

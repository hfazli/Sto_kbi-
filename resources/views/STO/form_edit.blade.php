                ...
                <select id="detail_lokasi" name="detail_lokasi" class="form-select">
                  <optgroup label="Childpart Area">
                    <option value="rak_a_a1_a25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_a_a1_a25' ? 'selected' : '' }}>
                      Area Rak A (A1-A25)</option>
                    <option value="rak_a_a26_a52"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_a_a26_a52' ? 'selected' : '' }}>
                      Area Rak A (A26-A52)</option>
                    <option value="rak_b_b1_b25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_b_b1_b25' ? 'selected' : '' }}>
                      Area Rak B (B1-B25)</option>
                    <option value="rak_b_b26_b54"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_b_b26_b54' ? 'selected' : '' }}>
                      Area Rak B (B26-B54)</option>
                    <option value="rak_c_c1_c25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_c_c1_c25' ? 'selected' : '' }}>
                      Area Rak C (C1-C25)</option>
                    <option value="rak_c_c26_c50"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_c_c26_c50' ? 'selected' : '' }}>
                      Area Rak C (C26-C50)</option>
                    <option value="rak_d_d1_d25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_d_d1_d25' ? 'selected' : '' }}>
                      Area Rak D (D1-D25)</option>
                    <option value="rak_d_d26_d50"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_d_d26_d50' ? 'selected' : '' }}>
                      Area Rak D (D26-D50)</option>
                    <option value="rak_e_e1_e25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_e_e1_e25' ? 'selected' : '' }}>
                      Area Rak E (E1-E25)</option>
                    <option value="rak_e_e26_e50"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_e_e26_e50' ? 'selected' : '' }}>
                      Area Rak E (E26-E50)</option>
                    <option value="rak_f_f1_f25"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_f_f1_f25' ? 'selected' : '' }}>
                      Area Rak F (F1-F25)</option>
                    <option value="rak_f_f26_f50"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_f_f26_f50' ? 'selected' : '' }}>
                      Area Rak F (F26-F50)</option>
                  </optgroup>
                  <optgroup label="Pakaging Area">
                    <option value="rak_packing"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_packing' ? 'selected' : '' }}>Area
                  ...
                  <optgroup label="Finished Good Area">
                    <option value="rak_finished_good_01"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_finished_good' ? 'selected' : '' }}>
                  ...
                  <optgroup label="Area Subcont">
                    <option value="rak_subcont_wip"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_subcont' ? 'selected' : '' }}>Area
                      Subcont FG</option>
                    <option value="rak_subcont_wip"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_subcont' ? 'selected' : '' }}>Area
                      Subcont WIP</option>
                  ...
                  <optgroup label="Area Delivery">
                    <option value="rak_delivery"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_delivery' ? 'selected' : '' }}>
                      Area Delivery</option>
                  </optgroup>
                  <optgroup label="Material Transit">
                    <option value="rak_material"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'Material' ? 'selected' : '' }}>Area
                  ...
                  <optgroup label="Shutter FG Fin">
                    <option value="rak_shutter_01"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_shutter_01' ? 'selected' : '' }}>
                      Area Shutter FG Fin Line 1-23 (16.1)</option>
                    <option value="rak_shutter_02"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_shutter_02' ? 'selected' : '' }}>
                      Area Shutter FG Fin Line 1-23 (16.2)</option>
                    <option value="rak_shutter_03"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_shutter_03' ? 'selected' : '' }}>
                      Area Shutter FG Fin Line 1-23 (16.3)</option>
                  </optgroup>
                  <optgroup label="QC Office Room">
                    <option value="rak_qc_wip"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_qc_wip' ? 'selected' : '' }}>Area
                      WIP QC Office</option>
                    <option value="rak_qc_fg"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_qc_fg' ? 'selected' : '' }}>Area
                      FG QC Office</option>
                  </optgroup>
                  <optgroup label="Manufacture Office">
                    <option value="rak_manufacture_FG"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_manufacture' ? 'selected' : '' }}>
                  ...
                  <optgroup label="WIP Lin Fin">
                    <option value="rak_wip_fin_01"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_wip_fin_01' ? 'selected' : '' }}>
                      Area Produksi (Finishing) WIP</option>
                  </optgroup>
                  <optgroup label="Childpart Fin">
                    <option value="rak_childpart_fin_01"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_childpart_fin_01' ? 'selected' : '' }}>
                      Area Childpart Fin Line (1-10)</option>
                    <option value="rak_childpart_fin_02"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_childpart_fin_02' ? 'selected' : '' }}>
                  ...
                  <optgroup label="WIP Rak Daisha">
                    <option value="rak_wip_daisha_01"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_wip_daisha' ? 'selected' : '' }}>
                  ...
                  <optgroup label="Area Service Part">
                    <option value="rak_service_part"
                      {{ old('detail_lokasi', $report->detail_lokasi ?? '') == 'rak_service_part' ? 'selected' : '' }}>
                      Area SPD</option>
                  </optgroup>
